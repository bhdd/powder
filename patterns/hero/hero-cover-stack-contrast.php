 ...
 * Slug: [themeslug]/hero-cover-stack-contrast
...
<div class="wp-block-cover alignfull has-base-color has-text-color" style="margin-top:0;min-height:600px"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container">
	...
	<div class="wp-block-group">
		...
		<h1 class="wp-block-heading" style="font-size:60px;font-style:normal;font-weight:300"><?php echo esc_html__( 'World-class interior design studio based in Laguna Beach.', '[themeslug]' ); ?></h1>
		<!-- /wp:heading -->
		...
		<div class="wp-block-group">
			...
			<p style="line-height:1"><?php echo esc_html__( 'Transform your space with our stylish design solutions.', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--60)">
			...
			<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background has-link-color wp-element-button" href="#"><?php echo esc_html__( 'Start Project →', '[themeslug]' ); ?></a></div>
			<!-- /wp:button -->
