 ...
 * Slug: [themeslug]/hero-columns-text-image
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center is-style-column-reverse">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-buttons">
				<!-- wp:button -->
				<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Call to Action', '[themeslug]' ); ?></a></div>
				<!-- /wp:button -->
