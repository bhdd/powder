 ...
 * Slug: [themeslug]/gallery-text-images
 * Categories: [themeslug]-gallery
 */
?>
<!-- wp:group {"metadata":{"name":"Gallery","categories":["[themeslug]-gallery"],"patternName":"[themeslug]/gallery-row"},"align":"full","style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center has-small-font-size" style="line-height:1.5;flex-basis:30%">
			...
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( '[themename] reclaims its minimalist roots by embracing simplicity and the purity of form and function. Its signature approach transcends conventional WordPress design standards, offering a canvas where creativity flourishes.', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p><a href="#"><?php echo esc_html__( 'View Gallery →', '[themeslug]' ); ?></a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
