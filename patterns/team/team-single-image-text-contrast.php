 ...
 * Slug: [themeslug]/team-single-image-text-contrast
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'Jennifer Kayne', '[themeslug]' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"5px"}}},"fontSize":"x-small"} -->
			<p class="has-x-small-font-size" style="margin-top:5px"><?php echo esc_html__( 'Chief Executive Officer', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'Raised under the sunny skies of Laguna Beach, she channels her coastal upbringing into creative leadership at a cutting-edge design studio, focusing on distinctive branding and digital innovation.', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
