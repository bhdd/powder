 ...
 * Slug: [themeslug]/team-columns-contrast
 * Categories: [themeslug]-team
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<h1 class="wp-block-heading alignwide has-text-align-center has-xx-large-font-size"><?php echo esc_html__( 'Team Members', '[themeslug]' ); ?></h1>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-column">
			...
			<h2 class="wp-block-heading has-text-align-center has-medium-font-size"><?php echo esc_html__( 'Jennifer Kayne', '[themeslug]' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"x-small"} -->
			<p class="has-text-align-center has-x-small-font-size" style="margin-top:0"><?php echo esc_html__( 'Chief Executive Officer', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"textAlign":"center","fontSize":"medium"} -->
			<h2 class="wp-block-heading has-text-align-center has-medium-font-size"><?php echo esc_html__( 'Anthony Hawk', '[themeslug]' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"x-small"} -->
			<p class="has-text-align-center has-x-small-font-size" style="margin-top:0"><?php echo esc_html__( 'Chief Operations Officer', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:social-links {"openInNewTab":true,"size":"has-small-icon-size","align":"center","className":"is-style-outline","style":{"spacing":{"blockGap":{"left":"5px"},"margin":{"top":"15px"}}}} -->
			<ul class="wp-block-social-links aligncenter has-small-icon-size is-style-outline" style="margin-top:15px">
				<!-- wp:social-link {"url":"https://x.com/","service":"x"} /-->
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"textAlign":"center","fontSize":"medium"} -->
			<h2 class="wp-block-heading has-text-align-center has-medium-font-size"><?php echo esc_html__( 'Autumn Cole', '[themeslug]' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"x-small"} -->
			<p class="has-text-align-center has-x-small-font-size" style="margin-top:0"><?php echo esc_html__( 'Chief Marketing Officer', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:social-links {"openInNewTab":true,"size":"has-small-icon-size","align":"center","className":"is-style-outline","style":{"spacing":{"blockGap":{"left":"5px"},"margin":{"top":"15px"}}}} -->
			<ul class="wp-block-social-links aligncenter has-small-icon-size is-style-outline" style="margin-top:15px">
				<!-- wp:social-link {"url":"https://x.com/","service":"x"} /-->
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"textAlign":"center","fontSize":"medium"} -->
			<h2 class="wp-block-heading has-text-align-center has-medium-font-size"><?php echo esc_html__( 'Zach Marley', '[themeslug]' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"x-small"} -->
			<p class="has-text-align-center has-x-small-font-size" style="margin-top:0"><?php echo esc_html__( 'Chief Financial Officer', '[themeslug]' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:social-links {"openInNewTab":true,"size":"has-small-icon-size","align":"center","className":"is-style-outline","style":{"spacing":{"blockGap":{"left":"5px"},"margin":{"top":"15px"}}}} -->
			<ul class="wp-block-social-links aligncenter has-small-icon-size is-style-outline" style="margin-top:15px">
				<!-- wp:social-link {"url":"https://x.com/","service":"x"} /-->
